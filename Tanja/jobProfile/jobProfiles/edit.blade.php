    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-11">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('jobProfiles.update', $profile->id) }}">
                        {{ method_field('PUT') }}
                        @csrf
